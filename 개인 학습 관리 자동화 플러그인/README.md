...
학교 포털에 흩어져 있는 과제 마감 정보와 강의 진행 현황을 한 번에 정리하고, 업로드한 학습 자료를 AWS Bedrock 기반 요약 흐름과 연결한 뒤 노션 페이지로 다시 구조화하는 과정에 초점을 맞췄습니다.
...
- AWS Bedrock Runtime 기반 AI 요약 흐름을 연결해, 자료 내용을 노션에 옮기기 좋은 형태의 학습 노트로 정리하도록 구성했습니다.
...
- AWS Bedrock Runtime SDK를 연결해 자료 요약과 핵심 bullet 생성을 자동화하고, 클라우드 기반 AI 기능을 실제 프로젝트 흐름에 적용했습니다.
...
- SQLite
- AWS Bedrock Runtime
- AWS SDK for JavaScript (`@aws-sdk/client-bedrock-runtime`)
- AWS Region 환경 설정 (`AWS_REGION`, `AWS_DEFAULT_REGION`)
- Notion API
- pdfjs-dist
- @ohah/hwpjs
