...
실행 화면은 결과 중심으로 확인할 수 있도록 세 가지 예시를 준비했습니다.

1. 과제/강의 마감 요약 리포트
2. 노션 정리 완료 메시지
3. 최종 노션 정리 페이지

스크린샷 파일은 아래 이름으로 `docs/screenshots` 폴더에 넣으면 README와 바로 연결할 수 있습니다.

- `docs/screenshots/deadline-report.png`
- `docs/screenshots/notion-share-summary.png`
- `docs/screenshots/notion-study-note.png`
